(function () {
	...
	angular.module("app", ["ngRoute",
		...
		return $routeProvider.when("/", {
		...
		}).when("/user/limitsetting", {
			templateUrl: "views/administration/limitsetting.html"
		}).when("/user/profile", {
			...
			templateUrl: "views/masters/pin.html"
		}).when("/masters/confighhvalue", {
			templateUrl: "views/masters/confighhvalue.html"
		...
		}).when("/masters/priceconfig", {
			templateUrl: "views/card/priceconfig.html"
			...
			templateUrl: "views/card/updaterdr.html"
		}).when("/card/txnsettlement", {
			templateUrl: "views/card/txnsettlement.html"
		}).when("/reports/transaction", {
			templateUrl: "views/reports/rpttransactions.html"
		}).when("/reports/cashtxn", {
			templateUrl: "views/reports/rptcashtxn.html"
		}).when("/reports/txnsummary", {
			templateUrl: "views/reports/rpttxnsummary.html"
		 }).when("/reports/bnfstatement", {
              templateUrl: "views/reports/rptbnfstatement.html"
		 }).when("/reports/devicetxn", {
             templateUrl: "views/reports/rptdevice.html"
		 }).when("/reports/cnsmsummary", {
             templateUrl: "views/reports/rptconsumption.html"
		 }).when("/reports/pricedetail", {
             templateUrl: "views/reports/rptpricelist.html"
